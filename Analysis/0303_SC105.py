...
rs=1e-4
Factor = 1e3
for file in glob.glob("../0227_Pastoll/Ant&Ca_0_Kv3_1.0_Kv7_1.0_gsinInh7.0_gsinExc0.0*_II_0.0_GAP_F_*.pkl"):
    ...
    cellTrace['0'] = fileInfo['simData']['V_soma']['cell_105']#20
    tSim = fileInfo['simData']['t']

cellTr0 = np.array(cellTrace['0'])
FileID = "0306_Pastoll/SC105_" 
############################################################################################
