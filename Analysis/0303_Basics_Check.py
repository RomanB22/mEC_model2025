...
minFreq=30.
maxFreq=300.
maxPower= None #700 # 100. # Sets the maximum for the scalogram. Varies according to the power of the signal. Change it for better visualization
colorbar=True
numBins = 2*125+1
###################################
...
FScellTrace={}
SCcellTrace={}
for file in glob.glob("../0303_Huang/Ant*gsinInh7.0*gsinExc0.0*GAP_T_*_*.pkl"):
...
fileID = '0303_Pastoll/0303_Huang_gsinInh7.0_gsinExc3.0_Const_11_'
...
for file in glob.glob("../0303_Huang/Const_11_Ant&Ca_0_Kv3_1.0_Kv7_1.0_gsinInh7.0_gsinExc3.0_EI_0.3_IE_0.2_II_0.0_GAP_T_*_data.pkl"):
    fileInfo = loadData(file)
    fileName = fileInfo['simConfig']['filename'][8:]
    print(fileName)
    sim_time = fileInfo['simConfig']['duration']
...
ax3.set_xlim(sim_time-2.*125.,sim_time); tmp = ax3.set_ylim(0.,60.)
