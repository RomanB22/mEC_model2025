...
cfg.NumModels = 1 if (cfg.HOMOGENEOUS and not cfg.GAP) else cfg.NPV
...
cfg.g_sinExc = 17.*1e-3 # Optogenetic conductance for the excitatory population. Around 17 for Mittal cell
...
for_raster = ['FS', 'SC'] # [5,11,12,15,18,25,29,35,43,50,55,56,57,65,67,68,70,71,72,76,78,81,93]# ['FS']
offset = 0
